...
int main(int argc, char** argv)
{
    ...
    switch (argc){
		case 3 : NumThreads=1;             ThreshLo=8; 	       ThreshHi=15;			PrThreads=NumThreads;		break;
		case 4 : NumThreads=atoi(argv[3]); ThreshLo=8; 	       ThreshHi=15;			PrThreads=NumThreads;		break;
		case 5 : NumThreads=atoi(argv[3]); ThreshLo=atoi(argv[4]); ThreshHi=15;			PrThreads=NumThreads;		break;
